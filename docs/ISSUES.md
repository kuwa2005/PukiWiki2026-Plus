...
| [#14](https://github.com/kuwa2005/PukiWiki2026/issues/14) | SPAM-02 | 編集時 CAPTCHA 導入 | **closed** | （feature/spam-captcha-links で対応） |
| [#15](https://github.com/kuwa2005/PukiWiki2026/issues/15) | SPAM-03 | ログイン・編集 POST のレート制限 | **closed** | `d16d16d`, `8df07f2` |
| [#16](https://github.com/kuwa2005/PukiWiki2026/issues/16) | SPAM-04 | 外部リンク POST 制限 | **closed** | （feature/spam-captcha-links で対応） |
