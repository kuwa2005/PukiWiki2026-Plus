...
| [#19](https://github.com/kuwa2005/PukiWiki2026/issues/19) | SEC-M03 | Wiki 記法によるインライン style XSS 残余 | 部分対応のみ（CSP ヘッダー）。記法サニタイズは未実装 |
| [#20](https://github.com/kuwa2005/PukiWiki2026/issues/20) | SEC-L01 | index.php の error_reporting 設定 | 本番向け `error_reporting(0)` への変更は未実施 |
| [#28](https://github.com/kuwa2005/PukiWiki2026/issues/28) | SEC-L05 | PHP 8.2/8.3/8.4 回帰テスト未実施 | CI / 自動テスト未整備 |
...
| [#31](https://github.com/kuwa2005/PukiWiki2026/issues/31) | SPAM-05 | Akismet 連携 — 編集 POST スパム判定 | open | 実装中 |
...
| [#19](https://github.com/kuwa2005/PukiWiki2026/issues/19) | SEC-M03 | インライン style XSS | open | CSP のみ（部分） |
...
| Issue | ID | タイトル | 状態 | 対応 commit |
|-------|-----|----------|------|-------------|
| [#20](https://github.com/kuwa2005/PukiWiki2026/issues/20) | SEC-L01 | error_reporting 設定 | open | — |
...
| [#28](https://github.com/kuwa2005/PukiWiki2026/issues/28) | SEC-L05 | PHP 8.2+ 回帰テスト | open | — |
